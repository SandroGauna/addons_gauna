odoo.define('app_odoo_customize.UserMenu', function (require) {
    ...
    //避免错误，要再定义
    var documentation_url = 'https://sgeboxapp.duckdns.org';
    var documentation_dev_url = 'https://sgeboxapp.duckdns.org';
    var support_url = 'https://sgeboxapp.duckdns.org';
    var account_title = 'Minha Conta';
    var account_url = 'https://sgeboxapp.duckdns.org';
