...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url',
                                                    default='https://www.sgeboxapp.duckdns.org/documentation/user/14.0/en/index.html')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url',
                                                        default='https://www.sgeboxapp.duckdns.org/documentation/14.0/index.html')
        app_support_url = ir_config.get_param('app_support_url', default='https://www.sgeboxapp.duckdns.org/trial/')
        app_account_title = ir_config.get_param('app_account_title', default='/web/login')
        app_account_url = ir_config.get_param('app_account_url', default='https://www.sgeboxapp.duckdns.org/web/login')
        app_enterprise_url = ir_config.get_param('app_enterprise_url', default='https://www.sgeboxapp.duckdns.org')
        app_ribbon_name = ir_config.get_param('app_ribbon_name', default='*sgeboxapp')
        res.update(
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_documentation_url",
                            self.app_documentation_url or "https://www.sgeboxapp.duckdns.org/documentation/user/14.0/en/index.html")
        ir_config.set_param("app_documentation_dev_url",
                            self.app_documentation_dev_url or "https://www.sgeboxapp.duckdns.org/documentation/14.0/index.html")
        ir_config.set_param("app_support_url", self.app_support_url or "https://www.sgeboxapp.duckdns.org/trial/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "https://www.sgeboxapp.duckdns.org/web/login")
        ir_config.set_param("app_enterprise_url", self.app_enterprise_url or "https://www.sgeboxapp.duckdns.org")
        ir_config.set_param("app_ribbon_name", self.app_ribbon_name or "*sgeboxapp")
